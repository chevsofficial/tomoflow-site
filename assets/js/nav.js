...
(() => {
  ...
  const authButtons = `
    <div class="auth-actions" id="authActions">
      <a class="btn btn-secondary btn-sm" data-auth="login" href="/auth">Login</a>
      <a class="btn btn-primary btn-sm" data-auth="signup" href="/auth?mode=signUp">Sign up</a>
    ...
    <header class="site-header">
      ...
      <aside class="drawer" id="drawer" aria-hidden="true">
        ...
        <nav class="drawer-nav" id="drawerNav" aria-label="Mobile">
          ${linkHtml(primaryLinks)}
          <a href="/auth" data-auth="login">Login</a>
          <a href="/auth?mode=signUp" data-auth="signup">Sign up</a>
